...
class TestV2IntervalsUpdatePost200Response(unittest.TestCase):
    """V2IntervalsUpdatePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2IntervalsUpdatePost200Response:
        """Test V2IntervalsUpdatePost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2IntervalsUpdatePost200Response`
        """
        model = V2IntervalsUpdatePost200Response()
        if include_optional:
            return V2IntervalsUpdatePost200Response(
                ...
                num_failed = 56,
                failed_intervals = [
                    oden.models._v2_intervals_update_post_200_response_failed_intervals_inner._v2_intervals_update_post_200_response_failed_intervals_inner(
                        id = '', 
                        error = '', )
                    ]
            )
    ...
    def testV2IntervalsUpdatePost200Response(self):
        """Test V2IntervalsUpdatePost200Response"""
