...
class TestDashboardExecuteFilters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteFilters:
        """Test DashboardExecuteFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteFilters`
        """
        model = DashboardExecuteFilters()
        if include_optional:
