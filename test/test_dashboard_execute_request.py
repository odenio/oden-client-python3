...
class TestDashboardExecuteRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteRequest:
        """Test DashboardExecuteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteRequest`
        """
        model = DashboardExecuteRequest()
        if include_optional:
            return DashboardExecuteRequest(
                ...
                filters = oden.models.dashboard_execute_filters.DashboardExecuteFilters(
                    lines = [
                        oden.models.dashboard_execute_filters_lines_inner.DashboardExecuteFilters_lines_inner(
                            id = '', 
                            name = '', )
                        ], 
                    shifts = [
                    ...
                    states = oden.models.dashboard_execute_filters_states.DashboardExecuteFilters_states(
                        ...
                        state_category_and_reasons = [
                            oden.models.dashboard_execute_filters_states_state_category_and_reasons_inner.DashboardExecuteFilters_states_state_category_and_reasons_inner(
                                state_category = 56, 
                                state_reason = '', )
                            ], ), 
                    custom_intervals = [
                        oden.models.dashboard_execute_filters_custom_intervals_inner.DashboardExecuteFilters_custom_intervals_inner(
                            type = '', 
                            value_contains = '', )
                        ], )
            )
