...
class TestDashboardExecuteFiltersCustomIntervalsInner(unittest.TestCase):
    """DashboardExecuteFiltersCustomIntervalsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardExecuteFiltersCustomIntervalsInner:
        """Test DashboardExecuteFiltersCustomIntervalsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteFiltersCustomIntervalsInner`
        """
        model = DashboardExecuteFiltersCustomIntervalsInner()
        if include_optional:
            return DashboardExecuteFiltersCustomIntervalsInner(
                type = '',
                value_contains = ''
            )
        else:
    ...
    def testDashboardExecuteFiltersCustomIntervalsInner(self):
        """Test DashboardExecuteFiltersCustomIntervalsInner"""
