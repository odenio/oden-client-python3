...
class TestScrapYieldData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScrapYieldData:
        """Test ScrapYieldData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrapYieldData`
        """
        model = ScrapYieldData()
        if include_optional:
            return ScrapYieldData(
                raw_data = '',
                id = '',
                var_schema = oden.models.scrap_yield_schema.ScrapYieldSchema(
                    id = '', 
