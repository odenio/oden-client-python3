...
class TestDashboardExecuteRequestDashboard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteRequestDashboard:
        """Test DashboardExecuteRequestDashboard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteRequestDashboard`
        """
        model = DashboardExecuteRequestDashboard()
        if include_optional:
