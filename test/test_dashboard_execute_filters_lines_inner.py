...
class TestDashboardExecuteFiltersLinesInner(unittest.TestCase):
    """DashboardExecuteFiltersLinesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardExecuteFiltersLinesInner:
        """Test DashboardExecuteFiltersLinesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteFiltersLinesInner`
        """
        model = DashboardExecuteFiltersLinesInner()
        if include_optional:
            return DashboardExecuteFiltersLinesInner(
                id = '',
                name = ''
            )
        else:
    ...
    def testDashboardExecuteFiltersLinesInner(self):
        """Test DashboardExecuteFiltersLinesInner"""
