...
class TestSearchLines409Response(unittest.TestCase):
    """SearchLines409Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchLines409Response:
        """Test SearchLines409Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchLines409Response`
        """
        model = SearchLines409Response()
        if include_optional:
            return SearchLines409Response(
                entity_name = '',
                num_matches = 56,
                error = '',
                retryable = True
    ...
    def testSearchLines409Response(self):
        """Test SearchLines409Response"""
