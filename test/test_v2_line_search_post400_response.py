...
class TestV2LineSearchPost400Response(unittest.TestCase):
    """V2LineSearchPost400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2LineSearchPost400Response:
        """Test V2LineSearchPost400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2LineSearchPost400Response`
        """
        model = V2LineSearchPost400Response()
        if include_optional:
            return V2LineSearchPost400Response(
                error = '',
                name = '',
                retryable = True
            )
    ...
    def testV2LineSearchPost400Response(self):
        """Test V2LineSearchPost400Response"""
