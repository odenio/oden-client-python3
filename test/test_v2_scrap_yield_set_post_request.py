...
class TestV2ScrapYieldSetPostRequest(unittest.TestCase):
    """V2ScrapYieldSetPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ScrapYieldSetPostRequest:
        """Test V2ScrapYieldSetPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ScrapYieldSetPostRequest`
        """
        model = V2ScrapYieldSetPostRequest()
        if include_optional:
            return V2ScrapYieldSetPostRequest(
    ...
    def testV2ScrapYieldSetPostRequest(self):
        """Test V2ScrapYieldSetPostRequest"""
