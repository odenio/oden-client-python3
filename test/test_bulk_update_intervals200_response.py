...
class TestBulkUpdateIntervals200Response(unittest.TestCase):
    """BulkUpdateIntervals200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateIntervals200Response:
        """Test BulkUpdateIntervals200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateIntervals200Response`
        """
        model = BulkUpdateIntervals200Response()
        if include_optional:
            return BulkUpdateIntervals200Response(
                ...
                num_failed = 56,
                failed_intervals = [
                    oden.models.bulk_update_intervals_200_response_failed_intervals_inner.bulk_update_intervals_200_response_failed_intervals_inner(
                        id = '', 
                        error = '', )
                    ]
            )
    ...
    def testBulkUpdateIntervals200Response(self):
        """Test BulkUpdateIntervals200Response"""
