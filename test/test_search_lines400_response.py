...
class TestSearchLines400Response(unittest.TestCase):
    """SearchLines400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchLines400Response:
        """Test SearchLines400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchLines400Response`
        """
        model = SearchLines400Response()
        if include_optional:
            return SearchLines400Response(
                error = '',
                name = '',
                retryable = True
            )
    ...
    def testSearchLines400Response(self):
        """Test SearchLines400Response"""
