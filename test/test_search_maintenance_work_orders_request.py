...
class TestSearchMaintenanceWorkOrdersRequest(unittest.TestCase):
    """SearchMaintenanceWorkOrdersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchMaintenanceWorkOrdersRequest:
        """Test SearchMaintenanceWorkOrdersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchMaintenanceWorkOrdersRequest`
        """
        model = SearchMaintenanceWorkOrdersRequest()
        if include_optional:
            return SearchMaintenanceWorkOrdersRequest(
                id = '',
                external_id = '',
    ...
    def testSearchMaintenanceWorkOrdersRequest(self):
        """Test SearchMaintenanceWorkOrdersRequest"""
