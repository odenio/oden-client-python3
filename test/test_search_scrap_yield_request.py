...
class TestSearchScrapYieldRequest(unittest.TestCase):
    """SearchScrapYieldRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchScrapYieldRequest:
        """Test SearchScrapYieldRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchScrapYieldRequest`
        """
        model = SearchScrapYieldRequest()
        if include_optional:
            return SearchScrapYieldRequest(
    ...
    def testSearchScrapYieldRequest(self):
        """Test SearchScrapYieldRequest"""
