...
class TestDashboardExecuteFiltersStatesStateCategoryAndReasonsInner(unittest.TestCase):
    """DashboardExecuteFiltersStatesStateCategoryAndReasonsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardExecuteFiltersStatesStateCategoryAndReasonsInner:
        """Test DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteFiltersStatesStateCategoryAndReasonsInner`
        """
        model = DashboardExecuteFiltersStatesStateCategoryAndReasonsInner()
        if include_optional:
            return DashboardExecuteFiltersStatesStateCategoryAndReasonsInner(
                state_category = 56,
                state_reason = ''
            )
        else:
    ...
    def testDashboardExecuteFiltersStatesStateCategoryAndReasonsInner(self):
        """Test DashboardExecuteFiltersStatesStateCategoryAndReasonsInner"""
