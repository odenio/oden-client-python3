...
class TestDashboardExecuteResultRange(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteResultRange:
        """Test DashboardExecuteResultRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteResultRange`
        """
        model = DashboardExecuteResultRange()
        if include_optional:
