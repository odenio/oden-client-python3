...
class TestSearchLines500Response(unittest.TestCase):
    """SearchLines500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchLines500Response:
        """Test SearchLines500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchLines500Response`
        """
        model = SearchLines500Response()
        if include_optional:
            return SearchLines500Response(
                error = '',
                retryable = True,
                id = ''
            )
    ...
    def testSearchLines500Response(self):
        """Test SearchLines500Response"""
