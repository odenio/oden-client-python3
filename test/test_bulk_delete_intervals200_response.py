...
class TestBulkDeleteIntervals200Response(unittest.TestCase):
    """BulkDeleteIntervals200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteIntervals200Response:
        """Test BulkDeleteIntervals200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteIntervals200Response`
        """
        model = BulkDeleteIntervals200Response()
        if include_optional:
    ...
    def testBulkDeleteIntervals200Response(self):
        """Test BulkDeleteIntervals200Response"""
