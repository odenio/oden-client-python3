...
class TestV2LineSearchPost409Response(unittest.TestCase):
    """V2LineSearchPost409Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2LineSearchPost409Response:
        """Test V2LineSearchPost409Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2LineSearchPost409Response`
        """
        model = V2LineSearchPost409Response()
        if include_optional:
            return V2LineSearchPost409Response(
                entity_name = '',
                num_matches = 56,
                error = '',
                retryable = True
    ...
    def testV2LineSearchPost409Response(self):
        """Test V2LineSearchPost409Response"""
