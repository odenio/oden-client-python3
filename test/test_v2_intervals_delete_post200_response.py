...
class TestV2IntervalsDeletePost200Response(unittest.TestCase):
    """V2IntervalsDeletePost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2IntervalsDeletePost200Response:
        """Test V2IntervalsDeletePost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2IntervalsDeletePost200Response`
        """
        model = V2IntervalsDeletePost200Response()
        if include_optional:
    ...
    def testV2IntervalsDeletePost200Response(self):
        """Test V2IntervalsDeletePost200Response"""
