...
class TestBulkUpdateIntervals200ResponseFailedIntervalsInner(unittest.TestCase):
    """BulkUpdateIntervals200ResponseFailedIntervalsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateIntervals200ResponseFailedIntervalsInner:
        """Test BulkUpdateIntervals200ResponseFailedIntervalsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateIntervals200ResponseFailedIntervalsInner`
        """
        model = BulkUpdateIntervals200ResponseFailedIntervalsInner()
        if include_optional:
            return BulkUpdateIntervals200ResponseFailedIntervalsInner(
                id = '',
                error = ''
            )
        else:
    ...
    def testBulkUpdateIntervals200ResponseFailedIntervalsInner(self):
        """Test BulkUpdateIntervals200ResponseFailedIntervalsInner"""
