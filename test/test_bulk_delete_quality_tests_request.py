...
class TestBulkDeleteQualityTestsRequest(unittest.TestCase):
    """BulkDeleteQualityTestsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteQualityTestsRequest:
        """Test BulkDeleteQualityTestsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteQualityTestsRequest`
        """
        model = BulkDeleteQualityTestsRequest()
        if include_optional:
            return BulkDeleteQualityTestsRequest(
                ids = [
                    ''
                    ],
    ...
    def testBulkDeleteQualityTestsRequest(self):
        """Test BulkDeleteQualityTestsRequest"""
