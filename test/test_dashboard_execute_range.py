...
class TestDashboardExecuteRange(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteRange:
        """Test DashboardExecuteRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteRange`
        """
        model = DashboardExecuteRange()
        if include_optional:
