...
class TestSetScrapYieldRequest(unittest.TestCase):
    """SetScrapYieldRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetScrapYieldRequest:
        """Test SetScrapYieldRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetScrapYieldRequest`
        """
        model = SetScrapYieldRequest()
        if include_optional:
            return SetScrapYieldRequest(
    ...
    def testSetScrapYieldRequest(self):
        """Test SetScrapYieldRequest"""
