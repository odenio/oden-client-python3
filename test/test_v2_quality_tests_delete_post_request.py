...
class TestV2QualityTestsDeletePostRequest(unittest.TestCase):
    """V2QualityTestsDeletePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2QualityTestsDeletePostRequest:
        """Test V2QualityTestsDeletePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2QualityTestsDeletePostRequest`
        """
        model = V2QualityTestsDeletePostRequest()
        if include_optional:
            return V2QualityTestsDeletePostRequest(
                ids = [
                    ''
                    ],
    ...
    def testV2QualityTestsDeletePostRequest(self):
        """Test V2QualityTestsDeletePostRequest"""
