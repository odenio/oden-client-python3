...
class TestDashboardExecuteFiltersStates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteFiltersStates:
        """Test DashboardExecuteFiltersStates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteFiltersStates`
        """
        model = DashboardExecuteFiltersStates()
        if include_optional:
