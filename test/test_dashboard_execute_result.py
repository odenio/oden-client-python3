...
class TestDashboardExecuteResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DashboardExecuteResult:
        """Test DashboardExecuteResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardExecuteResult`
        """
        model = DashboardExecuteResult()
        if include_optional:
