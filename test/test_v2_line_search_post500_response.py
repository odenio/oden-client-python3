...
class TestV2LineSearchPost500Response(unittest.TestCase):
    """V2LineSearchPost500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2LineSearchPost500Response:
        """Test V2LineSearchPost500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2LineSearchPost500Response`
        """
        model = V2LineSearchPost500Response()
        if include_optional:
            return V2LineSearchPost500Response(
                error = '',
                retryable = True,
                id = ''
            )
    ...
    def testV2LineSearchPost500Response(self):
        """Test V2LineSearchPost500Response"""
