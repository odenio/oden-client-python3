...
class QualityTestApi:
    ...
    def v2_quality_test_delete_post(
        ...
        :param quality_test: (required)
        :type quality_test: QualityTest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _v2_quality_test_delete_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if quality_test is not None:
            _body_params = quality_test
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/quality_test/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _v2_quality_test_search_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/quality_test/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
