...
class DashboardsApi:
    ...
    def execute_dashboard(
        self,
        dashboard_execute_request: DashboardExecuteRequest,
        ...
        :param dashboard_execute_request: (required)
        :type dashboard_execute_request: DashboardExecuteRequest
        ...
        _param = self._execute_dashboard_serialize(
            dashboard_execute_request=dashboard_execute_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[DashboardExecuteResult]",
    ...
    @validate_call
    def execute_dashboard_with_http_info(
        self,
        dashboard_execute_request: DashboardExecuteRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DashboardExecuteResult]]:
        """Execute a dashboard
    ...
    @validate_call
    def execute_dashboard_without_preload_content(
        self,
        dashboard_execute_request: DashboardExecuteRequest,
        _request_timeout: Union[
            None,
    ...
    def _execute_dashboard_serialize(
        self,
        ...
        if dashboard_execute_request is not None:
            _body_params = dashboard_execute_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/dashboard/execute',
