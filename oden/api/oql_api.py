...
class OQLApi:
    ...
    def v2_oql_query_post(
        ...
        :param oql_query: (required)
        :type oql_query: OQLQuery
        :param format: Format of the response. Can be `json`, `jsonextended` or `csv`. If unspecified, defaults to `jsonextended`. 
        :type format: str
    ...
    def _v2_oql_query_post_serialize(
        ...
        if oql_query is not None:
            _body_params = oql_query
