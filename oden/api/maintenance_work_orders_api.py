...
class MaintenanceWorkOrdersApi:
    ...
    def v2_maintenance_work_order_delete_post(
        ...
        :param maintenance_work_order: (required)
        :type maintenance_work_order: MaintenanceWorkOrder
    ...
    def _v2_maintenance_work_order_delete_post_serialize(
        ...
        if maintenance_work_order is not None:
            _body_params = maintenance_work_order
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/maintenance_work_order/delete',
    ...
    def _v2_maintenance_work_order_search_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/maintenance_work_order/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _v2_maintenance_work_order_set_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/maintenance_work_order/set',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
