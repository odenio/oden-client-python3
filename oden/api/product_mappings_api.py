...
class ProductMappingsApi:
    ...
    def v2_product_mapping_search_post(
        ...
        :param product_mapping: (required)
        :type product_mapping: ProductMapping
    ...
    def _v2_product_mapping_search_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/product_mapping/search',
    ...
    def _v2_product_mapping_set_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/product_mapping/set',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
