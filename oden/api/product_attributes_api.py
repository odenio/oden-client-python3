...
class ProductAttributesApi:
    ...
    def v2_product_attribute_search_post(
        ...
        :param product_attribute: (required)
        :type product_attribute: ProductAttribute
    ...
    def _v2_product_attribute_search_post_serialize(
        ...
        if product_attribute is not None:
            _body_params = product_attribute
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/product_attribute/search',
    ...
    def _v2_product_attribute_set_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/product_attribute/set',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
