...
class BulkUpdateIntervals200Response(BaseModel):
    """
    ...
    failed_intervals: Optional[List[BulkUpdateIntervals200ResponseFailedIntervalsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed_intervals": [BulkUpdateIntervals200ResponseFailedIntervalsInner.from_dict(_item) for _item in obj["failed_intervals"]] if obj.get("failed_intervals") is not None else None
        })
        return _obj
