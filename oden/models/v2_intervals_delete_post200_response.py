...
class V2IntervalsDeletePost200Response(BaseModel):
    """
    V2IntervalsDeletePost200Response
    """ # noqa: E501
    num_deleted: Optional[StrictInt] = None
    failed_intervals: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["num_deleted", "failed_intervals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed_intervals": obj.get("failed_intervals")
        })
        return _obj
