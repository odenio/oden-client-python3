...
class DashboardExecuteFiltersStatesStateCategoryAndReasonsInner(BaseModel):
    """
    DashboardExecuteFiltersStatesStateCategoryAndReasonsInner
    """ # noqa: E501
    state_category: StrictInt
    state_reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["state_category", "state_reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DashboardExecuteFiltersStatesStateCategoryAndReasonsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DashboardExecuteFiltersStatesStateCategoryAndReasonsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "state_category": obj.get("state_category"),
