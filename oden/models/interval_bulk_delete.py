...
class IntervalBulkDelete(BaseModel):
    """
    A range of intervals to delete
    """ # noqa: E501
    type: Optional[IntervalType] = None
    line: Optional[Line] = None
    start_time: Optional[datetime] = None
    end_time: Optional[datetime] = None
    hard_delete: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["type", "line", "start_time", "end_time", "hard_delete"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hard_delete": obj.get("hard_delete") if obj.get("hard_delete") is not None else True
        })
        return _obj
