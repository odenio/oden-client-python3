...
class DashboardExecuteFiltersStates(BaseModel):
    """
    DashboardExecuteFiltersStates
    """ # noqa: E501
    state_types: Optional[List[StrictStr]] = None
    state_category_and_reasons: Optional[List[DashboardExecuteFiltersStatesStateCategoryAndReasonsInner]] = None
    __properties: ClassVar[List[str]] = ["state_types", "state_category_and_reasons"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in state_category_and_reasons (list)
        _items = []
        if self.state_category_and_reasons:
            for _item_state_category_and_reasons in self.state_category_and_reasons:
                if _item_state_category_and_reasons:
                    _items.append(_item_state_category_and_reasons.to_dict())
            _dict['state_category_and_reasons'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "state_types": obj.get("state_types"),
            "state_category_and_reasons": [DashboardExecuteFiltersStatesStateCategoryAndReasonsInner.from_dict(_item) for _item in obj["state_category_and_reasons"]] if obj.get("state_category_and_reasons") is not None else None
        })
        return _obj
