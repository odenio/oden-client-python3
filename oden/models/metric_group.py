...
class MetricGroup(BaseModel):
    ...
    unit_kind_of_quantity: Optional[StrictStr] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["name", "description", "id", "unit_kind_of_quantity", "match"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "unit_kind_of_quantity": obj.get("unit_kind_of_quantity"),
