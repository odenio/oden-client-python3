...
class QualityTest(BaseModel):
    ...
    quality_schema: Optional[QualitySchema] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["id", "raw_data", "timestamp", "interval", "quality_schema", "match"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of quality_schema
        if self.quality_schema:
            _dict['quality_schema'] = self.quality_schema.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quality_schema": QualitySchema.from_dict(obj["quality_schema"]) if obj.get("quality_schema") is not None else None,
