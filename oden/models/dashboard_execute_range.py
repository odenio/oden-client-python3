...
class DashboardExecuteRange(BaseModel):
    """
    ...
    anchor: Optional[StrictStr] = Field(default=None, description="Anchor expression for a relative range, e.g. `now`.")
    offset: Optional[StrictStr] = Field(default=None, description="Offset expression for a relative range, e.g. `-7D`.")
    timezone: Optional[StrictStr] = Field(default=None, description="IANA timezone identifier (defaults to UTC).")
    __properties: ClassVar[List[str]] = ["start", "end", "anchor", "offset", "timezone"]
