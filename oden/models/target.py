...
class Target(BaseModel):
    ...
    lsl: Optional[Union[StrictFloat, StrictInt]] = None
    usl: Optional[Union[StrictFloat, StrictInt]] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["metric_group", "product", "line", "target_value", "lsl", "usl", "match"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of metric_group
        if self.metric_group:
            _dict['metric_group'] = self.metric_group.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric_group": MetricGroup.from_dict(obj["metric_group"]) if obj.get("metric_group") is not None else None,
