...
class DashboardExecuteFiltersCustomIntervalsInner(BaseModel):
    """
    DashboardExecuteFiltersCustomIntervalsInner
    """ # noqa: E501
    type: StrictStr
    value_contains: StrictStr
    __properties: ClassVar[List[str]] = ["type", "value_contains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DashboardExecuteFiltersCustomIntervalsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DashboardExecuteFiltersCustomIntervalsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "value_contains": obj.get("value_contains")
        })
        return _obj
