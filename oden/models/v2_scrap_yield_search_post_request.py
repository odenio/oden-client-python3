...
class V2ScrapYieldSearchPostRequest(BaseModel):
    """
    V2ScrapYieldSearchPostRequest
    """ # noqa: E501
    data: Optional[ScrapYieldData] = None
    interval: Interval
    __properties: ClassVar[List[str]] = ["data", "interval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ScrapYieldData.from_dict(obj["data"]) if obj.get("data") is not None else None,
