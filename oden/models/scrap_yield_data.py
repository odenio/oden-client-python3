...
class ScrapYieldData(BaseModel):
    """
    ...
    var_schema: Optional[ScrapYieldSchema] = Field(default=None, alias="schema")
    timestamp: Optional[datetime] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["raw_data", "id", "schema", "timestamp", "match"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "schema": ScrapYieldSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
