...
class DashboardExecuteRequest(BaseModel):
    ...
    range: Optional[DashboardExecuteRange] = None
    filters: Optional[DashboardExecuteFilters] = None
    __properties: ClassVar[List[str]] = ["dashboard", "range", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dashboard": DashboardExecuteRequestDashboard.from_dict(obj["dashboard"]) if obj.get("dashboard") is not None else None,
            "range": DashboardExecuteRange.from_dict(obj["range"]) if obj.get("range") is not None else None,
            "filters": DashboardExecuteFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
