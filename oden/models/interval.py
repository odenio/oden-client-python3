...
class Interval(BaseModel):
    ...
    metadata: Optional[IntervalMetadata] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["id", "type", "name", "line", "start_time", "end_time", "metadata", "match"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": IntervalType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "name": obj.get("name"),
            "line": Line.from_dict(obj["line"]) if obj.get("line") is not None else None,
            "start_time": obj.get("start_time"),
            "end_time": obj.get("end_time"),
            "metadata": IntervalMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
...
Interval.model_rebuild(raise_errors=False)
