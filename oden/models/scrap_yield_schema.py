...
class ScrapYieldSchema(BaseModel):
    """
    Scrap yield schema represents a factory's scrap/yield data ingestion configuration. 
    """ # noqa: E501
    id: Optional[UUID] = None
    factory: Optional[Factory] = None
    scrap_conversion_factor: Optional[Union[StrictFloat, StrictInt]] = None
    scrap_unit: Optional[Unit] = None
    yield_conversion_factor: Optional[Union[StrictFloat, StrictInt]] = None
    yield_unit: Optional[Unit] = None
    __properties: ClassVar[List[str]] = ["id", "factory", "scrap_conversion_factor", "scrap_unit", "yield_conversion_factor", "yield_unit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of scrap_unit
        if self.scrap_unit:
            _dict['scrap_unit'] = self.scrap_unit.to_dict()
        # override the default output from pydantic by calling `to_dict()` of yield_unit
        if self.yield_unit:
            _dict['yield_unit'] = self.yield_unit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "factory": Factory.from_dict(obj["factory"]) if obj.get("factory") is not None else None,
            "scrap_conversion_factor": obj.get("scrap_conversion_factor"),
            "scrap_unit": Unit.from_dict(obj["scrap_unit"]) if obj.get("scrap_unit") is not None else None,
            "yield_conversion_factor": obj.get("yield_conversion_factor"),
            "yield_unit": Unit.from_dict(obj["yield_unit"]) if obj.get("yield_unit") is not None else None
        })
        return _obj
