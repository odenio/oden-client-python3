...
class Factory(BaseModel):
    ...
    secondary_name: Optional[StrictStr] = None
    timezone: Optional[StrictStr] = None
    match: Optional[Match] = Match.UNIQUE
    __properties: ClassVar[List[str]] = ["id", "name", "secondary_name", "timezone", "match"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if secondary_name (nullable) is None
        # and model_fields_set contains the field
        if self.secondary_name is None and "secondary_name" in self.model_fields_set:
            _dict['secondary_name'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "secondary_name": obj.get("secondary_name"),
