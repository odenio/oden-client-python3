...
class V2IntervalsSetPost200Response(BaseModel):
    """
    V2IntervalsSetPost200Response
    """ # noqa: E501
    interval_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["interval_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interval_ids": obj.get("interval_ids")
        })
        return _obj
